...
{
    LogInfo("Starting MecchaSkeletonClean (merged)...");
    WNDCLASSEXW wc{};
    wc.cbSize = sizeof(wc);
    wc.style = CS_CLASSDC;
    ...
    // Colors - Sleek Cyberpunk/Neon Theme
    ...
    colors[ImGuiCol_Border]                 = ImVec4(0.20f, 0.20f, 0.27f, 0.85f);
    ...
    colors[ImGuiCol_TitleBg]                = ImVec4(0.11f, 0.09f, 0.16f, 1.00f);
    ...
    colors[ImGuiCol_ScrollbarGrabHovered]   = ImVec4(0.38f, 0.29f, 0.58f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabActive]    = ImVec4(0.48f, 0.35f, 0.75f, 1.00f);
    colors[ImGuiCol_CheckMark]              = ImVec4(0.58f, 0.27f, 0.94f, 1.00f);
    colors[ImGuiCol_SliderGrab]             = ImVec4(0.48f, 0.17f, 0.75f, 1.00f);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.68f, 0.25f, 0.98f, 1.00f);
    colors[ImGuiCol_Button]                 = ImVec4(0.20f, 0.13f, 0.35f, 1.00f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.31f, 0.18f, 0.58f, 1.00f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.42f, 0.23f, 0.77f, 1.00f);
    colors[ImGuiCol_Header]                 = ImVec4(0.18f, 0.12f, 0.30f, 1.00f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.28f, 0.18f, 0.48f, 1.00f);
    colors[ImGuiCol_HeaderActive]           = ImVec4(0.38f, 0.23f, 0.65f, 1.00f);
    colors[ImGuiCol_Separator]              = ImVec4(0.22f, 0.22f, 0.29f, 0.90f);
    colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.38f, 0.29f, 0.58f, 1.00f);
    colors[ImGuiCol_SeparatorActive]        = ImVec4(0.48f, 0.35f, 0.75f, 1.00f);
    colors[ImGuiCol_ResizeGrip]             = ImVec4(0.25f, 0.20f, 0.35f, 0.20f);
    colors[ImGuiCol_ResizeGripHovered]      = ImVec4(0.38f, 0.29f, 0.58f, 0.60f);
    colors[ImGuiCol_ResizeGripActive]       = ImVec4(0.48f, 0.35f, 0.75f, 0.90f);
    colors[ImGuiCol_Tab]                    = ImVec4(0.13f, 0.13f, 0.17f, 1.00f);
    colors[ImGuiCol_TabHovered]             = ImVec4(0.28f, 0.18f, 0.48f, 1.00f);
    colors[ImGuiCol_TabActive]              = ImVec4(0.35f, 0.21f, 0.60f, 1.00f);
    colors[ImGuiCol_TabUnfocused]           = ImVec4(0.08f, 0.08f, 0.11f, 1.00f);
    colors[ImGuiCol_TabUnfocusedActive]     = ImVec4(0.13f, 0.13f, 0.17f, 1.00f);
    colors[ImGuiCol_PlotLines]              = ImVec4(0.58f, 0.27f, 0.94f, 1.00f);
    colors[ImGuiCol_PlotLinesHovered]       = ImVec4(0.68f, 0.25f, 0.98f, 1.00f);
    colors[ImGuiCol_PlotHistogram]          = ImVec4(0.58f, 0.27f, 0.94f, 1.00f);
    colors[ImGuiCol_PlotHistogramHovered]   = ImVec4(0.68f, 0.25f, 0.98f, 1.00f);
    colors[ImGuiCol_TableHeaderBg]          = ImVec4(0.15f, 0.15f, 0.19f, 1.00f);
    colors[ImGuiCol_TableBorderLight]       = ImVec4(0.22f, 0.22f, 0.29f, 1.00f);
    colors[ImGuiCol_TableBorderStrong]      = ImVec4(0.28f, 0.28f, 0.37f, 1.00f);
    colors[ImGuiCol_TextSelectedBg]         = ImVec4(0.38f, 0.29f, 0.58f, 0.35f);
    colors[ImGuiCol_DragDropTarget]         = ImVec4(0.58f, 0.27f, 0.94f, 0.90f);
    colors[ImGuiCol_NavHighlight]           = ImVec4(0.58f, 0.27f, 0.94f, 1.00f);
    ...
    while (!done) {
        ...
        if (showMenu) {
            ...
            ImGui::Begin("Overlay", &showMenu, ImGuiWindowFlags_NoCollapse);
            ImGui::TextUnformatted("Insert toggles this panel | F5 quits");
            reader.DrawControls();
            ImGui::End();
        }
